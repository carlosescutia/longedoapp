    ...
    <div class="ui stackable grid">
                        ...
                        <tbody>
                            <?php foreach ($evaluados as $evaluados_item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form class="ui form" method="post" action="/carga_grado/eliminar_usuario" id="frm_del_usr<?=$evaluados_item['id_evaluacion_usuario']?>">
                                            <?php
                                                $mensaje = '¿Eliminar al alumno ' . $evaluados_item['nom_capoeira'] . ' ' . $evaluados_item['nom_usuario'];
                                                $forma = "#frm_del_usr" . $evaluados_item['id_evaluacion_usuario'] ;
                                            ?>
        ...
        <div class="row">
            <div class="ui basic segment">
                <a class="ui basic button" href="<?= site_url('carga_grado') ?>">Volver</a>
            </div>
        </div>
    </div>
</div>
